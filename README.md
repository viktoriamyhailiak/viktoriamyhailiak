...
⚛️ React | REST APIs | PostgreSQL  
🚀 I build modern web applications with clean architecture and great UX
...
### 🎮 2048 Game
Classic 2048 game implemented with clean game logic and dynamic UI updates.  
...
### 🖼 NAMU Museum
Landing page for purchasing museum event tickets with clean UX and structured layout.  
...
### 🧠 KateVR Landing Page
Advanced landing page implemented according to Figma design using BEM and SCSS.  
...
Responsive product landing page with modern layout and animations.  
